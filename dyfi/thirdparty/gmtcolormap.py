...
Copied directly from ShakeMap repo:
    https://github.com/usgs/shakemap/blob/master/shakemap/mapping/gmtcolormap.py
 
Usage:
    colors=GMTColorMap.loadFromCPT('./lib/mmi.cpt')
    col1=colors.getHexColor(intensity)[0]
    col2=colors.getRGBColor(intensity)[0]
