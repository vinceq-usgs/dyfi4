...
# -*- coding: utf-8 -*-
#
# DYFI documentation build configuration file, created by
# sphinx-quickstart on Fri Jun 24 17:09:56 2016.
#
...
latex_documents = [
    (master_doc, 'dyfi.tex', 'DYFI Manual',
     'Vince Quitoriano', 'manual'),
]
...
man_pages = [
    (master_doc, 'dyfi', 'DYFI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dyfi', 'USGS Did You Feel It? Documentation',
     'Vince Quitoriano', '', 'DYFI',
